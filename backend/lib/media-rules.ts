  ...
  return [...visuals]
    ...
    .map((item) => {
      ...
      if (item.startAt === undefined) {
        ...
        // If fadeOutSeconds is 0, no overlap â€” same as before.
...
// â”€â”€â”€ Auto-mode helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

// Deterministic LCG seeded by a string â€” same clip ID â†’ same random values.
...
export type AutoEnhancements = {
  ...
  speedVariation?: boolean; // random 0.75/1.0/1.25Ã— on video clips
...
export function summarizeComposition(
  ...
  // â”€â”€ Auto mode: randomised timing + optional music-driven sync â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (!hasManualAudio && visuals.some((v) => v.startAt === undefined)) {
    ...
    if (musicalEvents.length > 0) {
      // â”€â”€ Music-driven layout: each clip fills one musical section â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      // â”€â”€ Beat-exact sync: position each clip to start at a beat timestamp â”€â”€â”€
      if (beats.length >= 4 && bpm > 0) {
        const beatDur  = 60 / bpm;
        const halfBeat = Number((beatDur * 0.45).toFixed(3));
        const segs: VisualSegment[] = [];
        let beatIdx = 0;
        let gi = 0; // global clip index â€” cycles through orderedVisuals indefinitely
        ...
        // â”€â”€ Pure random (no beats): random durations aligned to BPM multiples â”€
    ...
    // â”€â”€ Post-processing enhancements â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    // Speed variation: 0.75Ã— / 1.0Ã— / 1.25Ã— on video clips (seeded per clip)
  ...
  // â”€â”€ Manual / mixed mode (unchanged) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
